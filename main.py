...
gw  = pygame.font.Font('freesansbold.ttf',72)
...
#game win
def game_win():
    gwin = gw.render("You are Win",True,(255,255,255))
    screen.blit(gwin, (180,300))
...
astro_x_list = [20,70,120,170,220,270,320,370,420,470,550,500,600,650,700]
